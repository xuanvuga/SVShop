			...
			<div class="well np">
				<div id="myCarousel" class="carousel slide homCar">
					<div class="carousel-inner">
						<div class="item">
							<img style="width: 100%"
								src="assets/user/img/bootstrap_free-ecommerce.png"
								alt="bootstrap ecommerce templates">
						...
						<div class="item">
							<img style="width: 100%" src="assets/user/img/carousel1.png"
								alt="bootstrap ecommerce templates">
							<div class="carousel-caption">
						...
						<div class="item active">
							<img style="width: 100%" src="assets/user/img/carousel3.png"
								alt="bootstrap ecommerce templates">
							<div class="carousel-caption">
						...
						<div class="item">
							<img style="width: 100%" src="assets/user/img/bootstrap-templates.png"
